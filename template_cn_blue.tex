...
% 辅助宏：用于 \cventry 第 1 个参数（日期栏）。当日期过长导致自动换行不美观时，
% 可显式拆成两行，例如 \cventry{\twoline{2027.09-}{2028.09}}{...}
% 使用 tabular[t] 顶部对齐，让右栏正文与日期第一行对齐而非第二行
...
\section{工作经历}
\cventry{\twoline{17.01-}{17.12}}{不长不短的公司名称}{可爱的项目}{https://keaidexiangmu.com}{}{工作中，
  我负责了 xxx 的开发和维护，运用 yyy 技术解决了 zzz 的重大问题。积极参与开源社
  区贡献}
\cventry{\twoline{16.01-}{16.12}}{好长的公司名称}{有趣的项
  目}{http://www.youqudexiangmu.com}{}{工作中，我按照领导的要求编程，做出了让领
  导满意的作品，为公司做出了贡献。我觉得我还是凑字数吧，编不下去了}
\cventry{\twoline{15.01-}{15.12}}{不知道叫什么的公司名称}{不可告人的项
  目}{http://bukegaoren.com}{}{独立编写了根本编不下去的项目简介，可能还是凑字数
  比较好，来凑字数吧来凑字数吧来凑字数吧。出色的完成了凑字数的工作，并获得了最佳
  凑字数员工奖}
\section{教育经历}
\cventry{\twoline{11.09-}{15.06}}{本科}{尼姑庵大学}{计算机科学与技术}{}{%
  \textbullet~最快编程大师一等奖 \\
  \textbullet~最强编程大师金奖 \\
  \textbullet~第 x 届「编程杯」gayhub 赛区一等奖 \\
  \textbullet~国家奖学金/三好学生/学生会主席/\emph{获得女朋友一个}%
}  % 奖项内嵌为描述参数，使右栏与 \twoline 日期等高对齐
\cventry{\twoline{15.09-}{18.06}}{硕士}{和尚庙大学}{软件工程}{实验室 XXX 导师 XXX}{主要研究了
